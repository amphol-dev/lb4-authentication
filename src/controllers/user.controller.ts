...
export class UserController {
  ...
  async create(
    ...
    if (newUserRequest.email !== undefined) {
      dataObj.email = newUserRequest.email;
    }
    if (newUserRequest.password !== undefined) {
      dataObj.password = newUserRequest.password;
    }
    validateCredentials(dataObj);
